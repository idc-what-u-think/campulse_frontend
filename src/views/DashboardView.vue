  ...
  <div class="min-h-screen bg-background pb-20">
    ...
    <div class="p-6 pt-8">
      ...
      <div class="grid grid-cols-2 gap-4 mb-8">
        <div class="bg-surface p-4 rounded-xl border border-primary/5 shadow-lg">
          <div class="text-3xl font-bold text-primary mb-1">{{ upcomingTasks }}</div>
      ...
      <div class="space-y-4">
        <router-link to="/planner" class="block bg-surface p-4 rounded-xl border border-primary/5 hover:border-accent/50 transition-all group">
          <div class="flex items-center gap-4">
            <div class="w-10 h-10 rounded-lg bg-accent/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
        ...
        <router-link to="/opportunities" class="block bg-surface p-4 rounded-xl border border-primary/5 hover:border-accent/50 transition-all group">
          <div class="flex items-center gap-4">
        ...
        <router-link to="/tutors" class="block bg-surface p-4 rounded-xl border border-primary/5 hover:border-accent/50 transition-all group">
          <div class="flex items-center gap-4">
