...
interface SignupProps {
  onSignup?: (userData: Omit<FormData, 'confirmPassword'>) => Promise<void>;
...
const Signup: React.FC<SignupProps> = ({
  ...
  const inputStyle = (hasError: boolean) => ({
    ...
    border: `2px solid ${hasError ? '#ef4444' : 'rgba(0, 46, 33, 0.15)'}`,
  ...
  const selectStyle = (hasError: boolean) => ({
    width: '100%',
    padding: isDesktop ? '0.875rem 1rem' : '0.75rem 0.875rem',
    border: `2px solid ${hasError ? '#ef4444' : 'rgba(0, 46, 33, 0.15)'}`,
    borderRadius: '0.75rem',
    background: 'linear-gradient(to bottom, #ffffff, #fafafa)',
    fontSize: isDesktop ? '1rem' : '0.875rem',
  ...
  return (
    <div style={{
      ...
      <style jsx>{`
        ...
        .blob-2 { animation: float 20s ease-in-out infinite; animation-delay: 5s; }
        .blob-3 { animation: float 20s ease-in-out infinite; animation-delay: 10s; }
      `}</style>
        ...
        <div style={{
          ...
          {success ? (
            <div style={{
              ...
              gap: '0.5rem',
              padding: '1rem',
              background: 'linear-gradient(135deg, rgba(74, 222, 128, 0.08), rgba(74, 222, 128, 0.12))',
            ...
            <div style={{
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  style={selectStyle(!!errors.school)}
                  onFocus={(e) => {
                    e.currentTarget.style.borderColor = '#f9dc5c';
                    e.currentTarget.style.boxShadow = '0 0 0 3px rgba(249, 220, 92, 0.15)';
                    e.currentTarget.style.background = '#ffffff';
              ...
              <div style={{
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    style={selectStyle(!!errors.level)}
                    onFocus={(e) => {
                      e.currentTarget.style.borderColor = '#f9dc5c';
                      e.currentTarget.style.boxShadow = '0 0 0 3px rgba(249, 220, 92, 0.15)';
                      e.currentTarget.style.background = '#ffffff';
